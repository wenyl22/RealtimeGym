...
def get_config():
    ...
    parser.add_argument("--user_name", type=str, default='user_name',help="[for wandb usage], to specify user's name for simply collecting training data.")
    parser.add_argument("--wandb_name", type=str, default='wandb_name',help="[for wandb usage], to specify user's name for simply collecting training data.")
    ...
    parser.add_argument("--eval_stochastic", action='store_true', default=False, help="use stochastic policy when eval")
    ...
    parser.add_argument("--critic_warmup_horizon", type=int, default=0, help="by default 0. The horizon to warm up critic.")
